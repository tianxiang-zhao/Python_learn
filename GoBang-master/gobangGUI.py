...
class GoBang(QWidget):
    ...
    def button1click(self):
        ...
        pygame.mixer.init()
        t = pygame.mixer.music.load("sound/backmusic.mp3")
    ...
    def button2click(self):
       QMessageBox.question(self, '战况', '失败:{}\n胜利：{}\n本局已走步数：{}'.format(self.fail,self.win,int(self.step/2)),
    ...
    #
    #     if(e.y()>540):
    #         print(self.mouse_point.pos().y())
    #         e.setCursor(Qt.PointingHandCursor)  # 鼠标变成手指形状
